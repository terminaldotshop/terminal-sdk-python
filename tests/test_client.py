...
from terminal import Terminal, AsyncTerminal, APIResponseValidationError
from terminal._types import Omit
from terminal._models import BaseModel, FinalRequestOptions
from terminal._constants import RAW_RESPONSE_HEADER
from terminal._exceptions import TerminalError, APIStatusError, APITimeoutError, APIResponseValidationError
from terminal._base_client import (
    DEFAULT_TIMEOUT,
...
class TestTerminal:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "terminal/_legacy_response.py",
                        "terminal/_response.py",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = Terminal(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
...
class TestAsyncTerminal:
    ...
    def test_base_url_trailing_slash(self, client: AsyncTerminal) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncTerminal) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncTerminal) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = AsyncTerminal(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    def test_get_platform(self) -> None:
        ...
        from terminal._utils import asyncify
        from terminal._base_client import get_platform 
