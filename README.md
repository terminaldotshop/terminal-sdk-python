...
<!-- prettier-ignore -->
[![PyPI version](https://img.shields.io/pypi/v/terminal-shop.svg?label=pypi%20(stable))](https://pypi.org/project/terminal-shop/)

The Terminal Python library provides convenient access to the Terminal REST API from any Python 3.9+
...
```sh
# install from PyPI
pip install terminal-shop[aiohttp]
```
...
```python
import asyncio
from terminal_shop import DefaultAioHttpClient
from terminal_shop import AsyncTerminal
